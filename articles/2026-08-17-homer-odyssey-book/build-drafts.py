#!/usr/bin/env python3
"""Assemble two 8-article WeChat drafts (上辑/下辑) from converted chapters."""
import json, os, sys

DIR = os.path.dirname(os.path.abspath(__file__))
CH = os.path.join(DIR, "chapters")
THUMB = sys.argv[1]
...
TITLE_OVERRIDE = {
  ...
  '08': '回家的路走了十年（下）｜第八章 · 木马屠城',
}

TAIL = ('<p><br></p>\n<section style="color:#888888;font-size:14px;">本篇选自小书'
...
part1 = ['intro', '01', '02', '03', '04', '05', '06', '07']
part2 = ['08', '09', '10', '11', '12', '13', '14', '15']

for name, nos in (("draft-1.json", part1), ("draft-2.json", part2)):
