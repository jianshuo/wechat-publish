在我给 AI 的常驻指令里，有一个最核心的文件，叫 `CLAUDE.md`。我在它的最前面写了一句话：<span style="color:#c0392b;">你永远叫我棒棒的建硕。</span>

这不是自恋，这是一只金丝雀。

AI 有个毛病：聊得越久，他的记忆越长，长到一定程度就开始忘事。背景一句话带过：模型的上下文窗口是 100 万 token，用到 65 万左右就会压缩，一压缩就会丢东西。这事值得单独写一篇，今天不展开。
...
<span style="color:#c0392b;">跟 AI 协作，可怕的不是他忘事，是你不知道他从什么时候开始忘的。</span>
